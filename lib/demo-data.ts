...
export const deals: Deal[] = [
 ...
 {id:"deal_acme",account:"Acme Corp",name:"Q3 Renewal",stage:"Proposal",value:45000,due:"In 2 days",owner:"Demo Rep",primaryContact:"Sarah Jenkins",budget:"$150k – $200k",timeline:"Q1 2024",decisionMaker:"Sarah Jenkins",competitors:"Logisync, Oracle"},
 {id:"deal_stark",account:"Stark Ind.",name:"Stark Ind. Pilot",stage:"Negotiation",value:250000,due:"Next week",owner:"Demo Rep",primaryContact:"Tony Stark",budget:"Not specified",timeline:"Not specified",decisionMaker:"Tony Stark",competitors:"Not specified"},
 {id:"deal_global",account:"GlobalNet",name:"GlobalNet Integration",stage:"Closed Won",value:85500,due:"Closed",owner:"Demo Rep",primaryContact:"Grace Ng",budget:"$85,500",timeline:"Closed",decisionMaker:"Grace Ng",competitors:"None"}
];
export const drafts: Draft[] = [
 {id:"draft_acme",callId:"call_acme",to:"sarah.j@acmecorp.com",subject:"Following up: Gravity + Acme Corp Ops Efficiency",status:"awaiting_approval",gmailDraftId:"demo_gmail_draft",body:`Hi Sarah,\n\nGreat speaking with you and the team today. It’s clear that reducing the 12% manual data entry error rate in your fulfillment centers is a top priority for Q1.\n\nAs promised, I’ve attached our technical documentation regarding the SAP integration to address your team’s architecture questions. We are confident we can deploy without disrupting your peak season operations.\n\nI will follow up shortly with a customized ROI calculator based on the $1.2M shrinkage figure we discussed.\n\nAre you and your lead architect available next Tuesday at 10 AM PST for a technical deep dive?\n\nBest,\nDemo Rep`},
 {id:"draft_globex",callId:"call_globex",to:"grace.ng@globalnet.com",subject:"Following up: Globex Q4 proposal",status:"sent",gmailDraftId:"demo_gmail_draft_2",body:`Hi Grace,\n\nThanks again for the time today. As discussed, I’ve attached the pricing proposal for the Q4 rollout, including the volume discounts we covered.\n\nPlease let me know if you need any adjustments before Friday — happy to walk your team through it.\n\nBest,\nDemo Rep`}
];
export const calls: Call[] = [
 {id:"call_acme",title:"Acme Corp Initial Discovery",date:"Today, 10:00 AM",duration:"45m 12s",source:"Zoom",dealId:"deal_acme",draftId:"draft_acme",status:"processed",transcriptUrl:"#demo-transcript",summary:"The Acme Corp team, led by Sarah Jenkins, VP Ops, is primarily concerned with reducing manual data entry errors across their fulfillment centers. They are currently using a legacy system that causes a 12% error rate, translating to roughly $1.2M in annual shrinkage. They expressed strong interest in our automated reconciliation module, provided it can integrate seamlessly with their existing SAP backend.",objections:["Implementation time might disrupt peak season operations.","Concerned about data residency requirements for their EU warehouses.","Pushback on per-user pricing model vs flat site license."],commitments:["Provide SAP integration technical documentation by Friday.","Schedule a deep-dive demo with their lead architect next week.","Send over a customized ROI calculator based on their $1.2M shrinkage figure."]},
 {id:"call_stark",title:"Stark Ind. Pilot Sync",date:"Yesterday, 4:15 PM",duration:"28m 40s",source:"Phone",dealId:"deal_stark",draftId:null,status:"input_needed",transcriptUrl:"#demo-transcript",summary:"Tony Stark confirmed Stark Ind. wants to pilot the automated reconciliation module across two warehouses. He asked for a firm implementation date and rollout plan. The confirmed go-live date was not stated in the transcript and is required before the deal can move forward.",objections:["Wants a firm implementation date before committing to the pilot window.","Asked about support SLAs during the pilot phase."],commitments:["Send pilot scope and rollout plan by Friday.","Tony will connect his ops lead for the site survey."]},
 {id:"call_globex",title:"Globex Initial Pitch",date:"Today, 9:15 AM",duration:"32m 08s",source:"Zoom",dealId:"deal_global",draftId:"draft_globex",status:"processed",transcriptUrl:"#demo-transcript",summary:"Grace Ng from Globex reviewed the Q4 pricing proposal and confirmed interest in expanding the rollout. She asked for volume discounts and a final quote by Friday, and confirmed the current integration is running smoothly across their existing regions.",objections:["Needs volume discounts to justify the Q4 expansion."],commitments:["Send final Q4 quote with volume pricing by Friday.","Grace will confirm the expanded region list by end of week."]}
];
export const tasks: Task[] = [
 {id:"task_1",title:"Send updated pricing proposal for Q3",source:"Acme Corp Sync",due:"Due Today",owner:"Rep",completed:false},
 {id:"task_2",title:"Provide technical specs for API integration",source:"Tech Review",due:"Due Tomorrow",owner:"Client",completed:false},
 {id:"task_3",title:"Schedule follow-up meeting with procurement",source:"Intro Call",due:"Due This Week",owner:"Rep",completed:true}
];
...
export const callTranscripts: Record<string,string> = {
 call_globex:`Grace Ng (GlobalNet): Thanks for sending the Q4 proposal over. The current integration is running smoothly across our existing regions.

Demo Rep: Glad to hear it. Any feedback on the pricing?

Grace Ng: We'd need volume discounts to justify expanding to the new regions. Can you have a final quote by Friday?

Demo Rep: Absolutely — I'll send the final Q4 quote with volume pricing by Friday.

Grace Ng: Perfect. I'll confirm the expanded region list by end of week.`,
